...
export const PRESETS: PreviewPreset[] = [
  ...
  {
    // uni-app 必须放在 vite 前面 —— vite-based uni-app 会同时命中 vite，
    // 但走 vite preset 会用错 npm script。
    id: "uniapp",
    name: "uni-app",
    icon: "simple-icons:vuedotjs",
    detect: (ctx) => hasNodeDep(ctx, "@dcloudio/uni-app"),
    command: "pnpm dev:h5",
    port: 9000,
    installCommand: "pnpm install",
    installMarker: ["node_modules"],
    readyRegex: /ready in|App running at|Network:/i,
    urlExtractRegex: /Local:\s+(https?:\/\/[^\s]+)/,
    docUrl: "https://uniapp.dcloud.net.cn/",
  },
  {
    id: "vue-cli",
    name: "Vue (CLI)",
    icon: "simple-icons:vuedotjs",
    detect: (ctx) => hasNodeDep(ctx, "@vue/cli-service"),
    command: "pnpm serve",
    port: 8080,
    installCommand: "pnpm install",
    installMarker: ["node_modules"],
    readyRegex: /App running at|DONE\s+Compiled successfully/i,
    urlExtractRegex: /Local:\s+(https?:\/\/[^\s]+)/,
    docUrl: "https://cli.vuejs.org/",
  },
  {
    id: "cra",
    name: "Create React App",
    icon: "simple-icons:react",
    detect: (ctx) => hasNodeDep(ctx, "react-scripts"),
    command: "pnpm start",
    port: 3000,
    installCommand: "pnpm install",
    installMarker: ["node_modules"],
    readyRegex: /Compiled successfully|webpack compiled/i,
    urlExtractRegex: /Local:\s+(https?:\/\/[^\s]+)/,
    docUrl: "https://create-react-app.dev/",
  },
  {
    id: "vite",
    name: "Vite",
