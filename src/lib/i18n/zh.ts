export const zh = {
  ...
  "settings.harness.desc": "任务 agent 把消息发给人时用哪条「网关 → 下游」。按用途分两类：工作（在场发群讨论）、无人值守（下班找你本人）。发到哪个群/人在发送时说明，这里不预设。Tower 只记录、不发送。",
  ...
  "settings.harness.notice": "Tower 会按配置的网关/下游把消息发出去，但对应渠道是否真正对接、能否送达，需要你自己检验。可点「测试」发一条试试。建议自建一个带对应机器人的专属群组、用唯一名称，避免同名的群/人导致发错。",
  ...
  "settings.harness.gateway.feishu": "飞书",
