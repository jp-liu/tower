export const zh = {
  ...
  "codeSearch.rgNotInstalledTitle": "需要安装 ripgrep",
  "codeSearch.rgNotInstalledDesc": "代码搜索依赖 ripgrep (rg)，请安装后使用。",
  "codeSearch.rgInstallBtn": "一键安装",
  "codeSearch.rgInstalling": "安装中...",
