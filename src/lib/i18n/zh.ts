export const zh = {
  ...
  "settings.harness.title": "多平台通知目标",
  "settings.harness.desc": "无人值守下，任务用哪些渠道联系你。Tower 只记录规则，实际发送由 agent 用平台工具完成。",
  "settings.harness.empty": "还没有目标。添加一个，无人值守任务才知道把消息发到哪里。",
  "settings.harness.addTarget": "添加目标",
  "settings.harness.remove": "删除",
  "settings.harness.saved": "已保存目标",
  "settings.harness.labelPlaceholder": "名称（如：后端值班群）",
  "settings.harness.addressPlaceholder": "地址（群/会话/人 id）",
  "settings.harness.downstreamPlaceholder": "网关下游渠道（如：微信）",
  "settings.harness.platform.feishu": "飞书",
  "settings.harness.platform.openclaw": "OpenClaw 网关",
