export const zh = {
  ...
  "settings.config.labels.desc": "管理标签及其级别；给标签配分支前缀后，带该标签的任务 worktree 分支名为「前缀/任务 id」",
  "settings.config.labels.pickWorkspace": "选择工作区",
  "settings.config.labels.levelSystem": "系统级",
  "settings.config.labels.levelWorkspace": "工作区级",
  "settings.config.labels.builtin": "内置",
  "settings.config.labels.builtinReadonly": "Tower 内置标记，不参与分支命名，不可修改",
