export const zh = {
  ...
  "harness.meta.delivered": "已送达",
  "harness.meta.notDelivered": "未送达",
  "harness.meta.notSent": "未推送",
  "harness.action.send": "发送",
  "harness.action.ignore": "忽略",
  "harness.action.resend": "重发",
  "harness.action.dismiss": "清除",
  "harness.toast.replySent": "已发送回复",
  "harness.toast.replyFailed": "回复失败",
  "harness.toast.resent": "已重发",
  "harness.toast.resendFailed": "重发失败",
