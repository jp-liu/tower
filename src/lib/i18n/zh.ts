export const zh = {
  ...
  "onboarding.step3.exampleCase1": "规则：主机 github.com，路径 ~/project",
  "onboarding.step3.exampleCase2": "规则：主机 gitlab.com，Owner 限定 team，路径 ~/work",
  "onboarding.step3.exampleDesc": "创建项目输入 Git 地址时，系统自动匹配规则填充本地路径",
