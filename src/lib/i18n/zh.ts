export const zh = {
  ...
  "shortcuts.missions.prevPane": "上一个终端",
  "shortcuts.missions.moveSel": "移动选中（方向键）",
  "shortcuts.missions.cyclePane": "循环切换（Tab）",
  "shortcuts.missions.focusSel": "聚焦选中窗格",
  "shortcuts.missions.exitToNav": "退回导航模式",
