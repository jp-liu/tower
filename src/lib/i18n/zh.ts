export const zh = {
  ...
  "settings.config.system.taskDefaultWorktree": "新建任务默认启用分支隔离",
  "settings.config.system.taskDefaultWorktreeHint": "创建任务对话框中「分支隔离」开关的初始值",
  "settings.config.system.taskDefaultAutoStart": "新建任务后默认自动启动",
  "settings.config.system.taskDefaultAutoStartHint": "创建任务对话框中「创建后自动启动」开关的初始值",
