...
export const en: Translations = {
  ...
  "settings.config.labels.desc": "Manage labels and their level. Give a label a branch prefix and tasks carrying it get the worktree branch <prefix>/<task id>",
  "settings.config.labels.pickWorkspace": "Pick a workspace",
  "settings.config.labels.levelSystem": "System",
  "settings.config.labels.levelWorkspace": "Workspace",
  "settings.config.labels.builtin": "builtin",
  "settings.config.labels.builtinReadonly": "Tower's own marker — not part of branch naming, not editable",
  ...
  "settings.config.labels.add": "Add",
