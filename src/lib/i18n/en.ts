...
export const en: Translations = {
  ...
  "settings.harness.title": "Notify targets (multi-platform)",
  "settings.harness.desc": "Which channels tasks use to reach you when unattended. Tower only stores the rules — the agent does the actual sending via platform tools.",
  "settings.harness.empty": "No targets yet. Add one so unattended tasks know where to send.",
  "settings.harness.addTarget": "Add target",
  "settings.harness.remove": "Remove",
  "settings.harness.saved": "Targets saved",
  "settings.harness.labelPlaceholder": "Name (e.g. Backend on-call)",
  "settings.harness.addressPlaceholder": "Address (group / chat / person id)",
  "settings.harness.downstreamPlaceholder": "Gateway downstream channel (e.g. WeChat)",
  "settings.harness.platform.feishu": "Feishu",
  "settings.harness.platform.openclaw": "OpenClaw gateway",
