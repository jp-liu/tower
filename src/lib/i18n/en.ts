...
export const en: Translations = {
  ...
  "settings.prompts.builtin.systemDesc": "Injected as a system prompt on every task start (Git commit / push rules, etc.). Editable; \"Reset to default\" restores the built-in version. Cannot be deleted.",
