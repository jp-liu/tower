...
export const en: Translations = {
  ...
  "onboarding.step2.title": "Verify AI Command Line Tool",
  "onboarding.step2.desc": "Tower requires Claude CLI to execute AI tasks — ensure it is installed and configured",
