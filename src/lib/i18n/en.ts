...
export const en: Translations = {
  ...
  "settings.harness.notice": "Tower sends via the configured gateway/downstream, but whether the channel is actually wired up and can deliver is for you to verify. Hit \"Test\" to send one and check. Tip: create a dedicated group with the bot in it and a unique name, to avoid sending to the wrong same-named group/person.",
  ...
  "settings.harness.gateway.feishu": "Feishu",
