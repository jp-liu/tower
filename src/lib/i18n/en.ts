...
export const en: Translations = {
  ...
  "settings.harness.title": "Unattended send channels",
  "settings.harness.desc": "Which \"gateway → downstream\" route sends messages when unattended, via the agent's tools. Where to send (group/person) is stated at send time — not preset here. Tower only records, never sends.",
