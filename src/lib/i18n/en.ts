...
export const en: Translations = {
  ...
  "onboarding.step3.exampleCase1": "Rule: host github.com, path ~/project",
  "onboarding.step3.exampleCase2": "Rule: host gitlab.com, owner team, path ~/work",
  "onboarding.step3.exampleDesc": "When creating a project with a Git URL, the local path is auto-filled based on matching rules.",
