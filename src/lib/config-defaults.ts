...
export const CONFIG_DEFAULTS: Record<string, ConfigEntry> = {
  ...
  "task.systemDirective": {
    defaultValue: [
      ...
      "- When the target is `o-tower`, a sibling Tower task, or an operator agent such as `xiao-fei`, use the `tower-bridge` skill instead of `tower-ask`. `tower-ask` is only for real humans/groups/channels.",
