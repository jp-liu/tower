...
const translations = {
  zh: {
    ...
    "taskPage.uncommittedChanges": "工作区有 {count} 个未提交的文件，请先提交或放弃修改后再完成任务",
  ...
  en: {
    ...
    "taskPage.uncommittedChanges": "Worktree has {count} uncommitted file(s). Please commit or discard changes before completing the task",
    // File tree (Phase 20)
