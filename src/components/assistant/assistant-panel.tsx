      ...
      <div className="h-[44px] border-b border-border flex items-center px-4 gap-2 bg-popover">
        ...
        {communicationMode === "chat" && (
          <>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger
                className="flex items-center gap-1 h-8 px-2 rounded-md text-xs text-muted-foreground hover:bg-accent hover:text-accent-foreground transition-colors max-w-[120px] truncate"
