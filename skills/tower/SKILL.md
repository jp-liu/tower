...
11. **Unattended send/receive** follows [references/unattended-messaging.md](references/unattended-messaging.md): unattended OWNER messages use one authorized CapabilityRequest; explicit work-recipient messages use `push_to_human`; every outbound carries `[[tower:task=<taskId>]]`.
