...
const REQUIRED_FILES = [
  ...
  "scripts/migrations/0030-capability-runtime.ts",
  ...
  "extensions/tower-agent/openclaw-capability/runtime.js",
...
function assertReleasePackage(pack, pkg, runtimePkg) {
  ...
  if (pack.version !== pkg.version) {
    errors.push(`package version mismatch: manifest=${pkg.version} pack=${pack.version}`);
  }
