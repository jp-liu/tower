...
- **42 tools in 11 categories**: Workspace CRUD, Project CRUD, Task management, Label management, Search, Project identification, Project knowledge base, Notes & Assets, Terminal I/O, Reporting, and Harness messaging (see the [Harness module](./harness)).
...
| `harness-tools.ts` | 6 | Unattended messaging: list_notify_targets / push_to_human / ask_human / notify_human / reply_to_ask / relay_channel_reply (see the [Harness module](./harness)) |
